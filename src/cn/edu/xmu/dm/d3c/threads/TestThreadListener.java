...
public class TestThreadListener extends Thread {
	//
	public static boolean isOver = false;
	//
	public ArrayList<IndependentTestThread> array = new ArrayList<IndependentTestThread>();
	//
	long sleepTime = 1000;
	//
	public void run() {
		...
		while (!flag) {
			...
			if (array.size() == 0) {
				...
				// 如果统计线程都已经完成
				flag = true;
				TestThreadListener.isOver = true;
			}
		}
	}
}
