...
public class CorreclationCoefficientP {
	// 计算两个分类器之间的不一致度量
	public static double CalculateDis(List<Integer> first, List<Integer> second) {
		...
		return (n11 * n00 - n01*n10) / Math.sqrt((n11+n10)*(n01+n00)*(n11+n01)*(n10+n00)); 
	}
...
public static void main(String[] args) throws Exception {
		...
		CorreclationCoefficientP cd = new CorreclationCoefficientP();
