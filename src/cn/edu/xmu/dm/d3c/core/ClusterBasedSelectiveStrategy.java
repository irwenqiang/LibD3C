...
public class ClusterBasedSelectiveStrategy {
	...
	String selectiveAlgorithm="DS";
	String CCAlgorithm="EBSS";
	
	//基于聚类的选择策略
	public List<String> doClusterBasedSelectiveStrategy(Instances input, Classifier[] cfsArray, int numfolds,List<String> pathOfClassifiers,List<String> parameterOfCV)throws Exception{
		int i;
		...
		wcit.IndependentlyTrainWeakClassifiers(input, cfsArray, numfolds, pathOfClassifiers, parameterOfCV);
