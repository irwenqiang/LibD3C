...
public class WeakClassifiersIndependentTrainer {
	...
	public void IndependentlyTrainWeakClassifiers(Instances input, Classifier[] cfsArray, int numfolds,List<String> pathOfClassifiers,List<String> parameterOfCV) throws Exception {
		int i, j;
